...
"
                ...
                eventObj = new Event()
                {
                    Title = @"NARCA 2017 Fall Conference",
                    CreatedDate = Convert.ToDateTime("2017-10-03 21:40:05.8012035"),
...
"
                ...
                eventObj = new Event()
                {
                    Title = @"Becket & Lee Attended the 2017 Debt Connection Symposium and Expo ",
                    CreatedDate = Convert.ToDateTime("2017-08-08 15:39:25.7972068"),
                    StartDate = Convert.ToDateTime("2017-09-11 00:00:00.0000000"),
                    EndDate = Convert.ToDateTime("2017-09-13 00:00:00.0000000"),
                    EventTypeId = 2,
                    EventHtml = @"&lt;p style=&quot;margin-left:0in; margin-right:0in&quot;&gt;&lt;span style=&quot;font-size:12pt&quot;&gt;&lt;span style=&quot;color:#000000&quot;&gt;Partner Tom Lee and Business Operations Analyst Stu Cramer attended the 2017 Debt Connection Symposium &amp;amp; Expo in Tucson, AZ, September 11-13, 2017. The firm exhibited at this conference geared for collections, recovery, and debt sales professionals. Tom Lee spoke during the &amp;quot;Fast Track Presentation&amp;quot; on September 12th, his topic, Bankruptcy Update. Discussion points covered, among other things, updates on Midland Funding, LLC v. Johnson (decided on May 15, 2017 by the Supreme Court of the United States) and the upcoming bankruptcy rule changes scheduled for implementation on December 1, 2017 that include shortening the time within which creditors may file proofs of claims in chapter 13 bankruptcies. &lt;/span&gt;&lt;/span&gt;&lt;/p&gt;
"
                }; context.Events.Add(eventObj);
                eventObj = new Event()
                {
