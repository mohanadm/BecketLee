...
"
                ...
                context.Events.Add( eventObj );
eventObj = new Event() { Title = @"A Claimant's Dilemma:  The Statute of Limitations and Proofs of Claim",  CreatedDate = Convert.ToDateTime("2015-04-21 14:46:31.4570000"),  EventTypeId = 3,  EventHtml = @"
...
&lt;/p&gt;" }; context.Events.Add( eventObj );
eventObj = new Event() { Title = @"FILER BEWARE! IT'S NOT JUST THE RULES COMMITTEE CHANGING THE RULES",  CreatedDate = Convert.ToDateTime("2014-11-20 20:10:39.9730000"),  EventTypeId = 3,  EventHtml = @"
...
&lt;/p&gt;
&lt;p&gt;
Reprinted from Norton Bankruptcy Law Adviser, (September 2014) with permission. Copyright &#169; (2014) Thomson Reuters/West. 
...
eventObj = new Event() { Title = @"Proofs of Claim - Two Cases and a Lesson Learned",  CreatedDate = Convert.ToDateTime("2011-10-31 17:57:48.2400000"),  EventTypeId = 3,  EventHtml = @"
&lt;p style=&quot;text-align: center&quot;&gt;
...
Copyright &#169; (2010) Thomson Reuters/West.  For more information about this 
publication please visit &lt;a href=&quot;http://www.west.thomson.com&quot; target=&quot;blank&quot;&gt;
www.west.thomson.com.&lt;/a&gt;

&lt;/p&gt;" }; context.Events.Add( eventObj );
eventObj = new Event() { Title = @"Projected Disposable Income Captures the Attention of the Supreme Court -Twice!",  CreatedDate = Convert.ToDateTime("2011-10-31 17:57:15.1400000"),  EventTypeId = 3,  EventHtml = @"
...
Copyright &#169; (2011) Thomson Reuters/West.  For more information about this 
publication please visit &lt;a href=&quot;http://www.west.thomson.com&quot; target=&quot;blank&quot;&gt;
www.west.thomson.com.&lt;/a&gt;
&lt;/p&gt;" }; context.Events.Add( eventObj );
